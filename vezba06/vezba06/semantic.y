...
_LPAREN parameter _RPAREN {NumberOfReturns = 0;}body
{
...
: _ID
{
  ...
  if(idx != -1 && get_atr2(idx) == CurrentBlockLevel)
    ...
    {
      insert_symbol($1, VAR, vartype, ++var_num, CurrentBlockLevel);
    }
}
| ids _COMMA _ID
{
  ...
  if(idx != -1 && get_atr2(idx) == CurrentBlockLevel)
    ...
    insert_symbol($3, VAR, vartype, ++var_num, CurrentBlockLevel);
      }
;
...
statement
  ...
  | if_statement
  | return_statement {NumberOfReturns++;}
  ;
